...
<title>luis3ignacio Website <?php if(isset($_GET['nobox'])) echo '- nobox'?></title>
<link rel="shortcut icon" href="favico.ico" />
<script src="scripts/AC_RunActiveContent.js" type="text/javascript"></script>

<style>
.SpecialBlock { padding: 0 0 5px 10px; font-style:italic; }
.little { font: 8px Arial; }
.ImagesBlock {
	position:relative;
	z-index:2;
	float:right; 
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-9396081-2']);
...
<div class="ImagesBlock" <?php if(isset($_GET['nobox'])) echo 'style="display:none;"'?>>
<div align="right" >
<span onclick="alert('Hello!');">[Hello!]</span>
<a href="?nobox">[?nobox]</a>
<a align="right" href="javascript:void(0);" onclick="this.parentNode.parentNode.style.display='none';">[Cerrar]</a>
</div>

<a href="http://www.spring.org.uk/2007/08/how-to-build-courage-through.php"><img src="small_files/fire_fighters.jpg" border="0"  /></a><br />
<a href="http://luis3ignacio.blogspot.com"><img src="small_files/luis3ignacio_yin_yang_s.gif" border="0" /></a> <br /> <!--ign_yin_yang.gif-->
<a href="http://thiaoouba.com/aura_eye_exercise.htm"><img src="small_files/cross-ex-right.gif" border="0" /></a> <br />
<img src="small_files/Duke-Tux-ElePHPant-Dolphin.jpg" border="0" /><br />
<a href="http://godlessgeeks.com/LINKS/GodProof.htm">God?</a><br />

<!-- google_ad_section_end(name=default) -->
<div class='inline-ad' style="float:right;">
<script type="text/javascript"><!--
google_ad_client="pub-9377138062912963";
...
<!-- google_ad_section_start -->
	...
	<a href="http://www.spoj.pl/problems/classical/"><i>(Classical)</i></a> &nbsp; &nbsp; 
	The best source of programming exercises. Very thankful!!! ;-)
	<br />
	<a href="http://projecteuler.net/"><b>Project Euler</b></a> &nbsp; 
    Another <b>GOOD</b> source of programming exercises
    <br />
    

	<a href="http://codingbat.com/"><b>Coding Bat</b></a> &nbsp; 
	(Java & Python <b>ONLINE</b> Exercises)
	<br /> 

	<a href="http://www.topcoder.com/tc?module=Static&d1=tutorials&d2=alg_index"><b>TopCoder</b></a>
	(Educational Content - Algorithm Tutorials)
	<br />

	<a href="http://blogs.lessthandot.com/index.php/ITProfessionals/EthicsIT/collection-of-puzzles-for-programmers"><b>LessThanDot</b></a>
	Collection Of Puzzles For Programmers
	<br />

	<i><a href="http://www.javablackbelt.com/Home.wwa">Java Black Belt</a> (Java Exams)</i> &nbsp; -- &nbsp; 
	bought by <a href="http://www.skillsoft.com/"><b>Skillsoft</b></a> &nbsp; 
	<br /> 	
...
<a href="/txt-doc/rasmus_rails.html"><strong>Rasmus Lerdorf</strong> thoughts about <strong>Ruby On Rails</strong></a> <br />
    ...
    <a href="https://addons.mozilla.org/es-ES/firefox/addon/1250/">Grab and Drag Firefox Plugin</a><br />
    ...
    <a href="http://download.oracle.com/javase/6/docs/api/java/util/Formatter.html">Formatter</a> &nbsp; - &nbsp;
	...
	<b>By Rasmus Lerdorf:</b><br />
		...
		<a href="http://talks.php.net/show/oscon06">Getting Rich with PHP 5</a> &nbsp; -&nbsp; 
	...
	<a href="http://luis3ignacio.awardspace.com/codes/?f=././/php//file_read_write.php">My Read Write</a><br /><br />
    ...
    <a href="http://sourceforge.net/project/showfiles.php?group_id=57663&package_id=53241">NuSOAP</a> &nbsp; &nbsp; &nbsp; 
    ...
    <a href="http://weblogtoolscollection.com/regex/regex.php">Regular Expressions</a> - 
		...
		<a href="http://www.adobe.com/devnet/dreamweaver/articles/regular_expressions.html">Dreamweaver</a> &nbsp;
		<br />
   ...
   <strong>JavaScript Resources:</strong><br /> 
	...
	<b><i><a href="http://charupload.wordpress.com/2007/12/07/jquery-documentation-chm/">jQuery documentation (CHM)</i></b> <br />
	</div>
	...
	and <a href="http://xregexp.com/plugins/">Unicode addon</a>
    <br />
   ...
   <a href="http://code.google.com/p/swfupload/">SWFUpload</a> &nbsp; - &nbsp;
        <i><a href="http://demo.swfupload.org/Documentation/">(Documentation)</a></i>
		<br />
   ...
   <a href="http://homepage.ntlworld.com/bobosola/pnghowto.htm">PNG-Fix</a> &nbsp; - &nbsp;
    ...
    <a href="http://phpjs.org/">PHP.JS</a> &nbsp - &nbsp;
   ...
   <a href="http://www.wrox.com/WileyCDA/WroxTitle/Professional-Ajax-2nd-Edition.productCd-0470109491,descCd-DOWNLOAD.html">Professional Ajax, 2nd. Edition - Examples</a><br />
    <a href="http://code.google.com/apis/maps/documentation/examples/">Google Maps Examples and API</a> -
			<a href="http://code.google.com/apis/maps/documentation/examples/event-arguments.html">Arguments: Lat Lng Zoom</a> - 
			<a href="/get_google_coordinates.html">[Coordinates]</a>
            <br />
   ...
   <strong>CSS Resources:</strong> &nbsp; 
			<i>See <a href="http://jigsaw.w3.org/css-validator/#validate_by_input">CSS Validator</a></i><br />
	...
	<a href="http://www.hedgerwow.com/360/bugs/css-select-free.html">&lt;SELECT&gt; Free Layer</a> 
	 - <a href="/codes-txt/js/ign_iframe_hack.html">A short example [Check it in IE6]</a> <br />
	...
	<a href="http://devsushi.com/2007/12/02/blackberry-jde-api-user-interface-field-reference/">User Interface Field Reference</a><br />
    ...
    <a href="http://docs.blackberry.com/en/developers/subcategories/?userType=21&category=API+Reference+%26+Release+Notes">API Reference</a> : &nbsp; 
        ...
        <a href="http://www.blackberry.com/developers/docs/4.2.1api/">v4.2.1 (8320,8100)</a> &nbsp; - &nbsp; 
        <br />
	
    <a href="http://supportforums.blackberry.com/t5/Java-Development/BlackBerry-Java-Development-Environment-Tutorials/ta-p/442668"><strong>BB JDE Tutorials</strong></a> &nbsp; - &nbsp; 
        <a href="http://us.blackberry.com/developers/resources/simulators.jsp">Simulators</a> &nbsp; - &nbsp; 
        <a href="http://us.blackberry.com/developers/javaappdev/javadevenv.jsp">JDEs</a><br />
	...
	<a href="http://www.freechess.org/Login/jin/applet.php">Jin Applet</a> &nbsp; - &nbsp;
	<i>freechess.org</i> &nbsp;
	<div class="SpecialBlock">
	...
	<a href="http://www.freechess.org/Help/HelpFiles/variables.html">[Variables]</a> &nbsp; 
	...
	<br />
	<br />
	<a href="http://alemanni.pagesperso-orange.fr/index.html">Checkers Programs Page (JB Alemanni)</a> &nbsp; - &nbsp; 
	<a href="http://alemanni.pagesperso-orange.fr/canadian.html">Canadian Draughts</a> &nbsp; - &nbsp;  
	<a href="hhttp://alemanni.pagesperso-orange.fr/srilankan.html">Sri Lankan Draughts</a>
	</div>
	...
	Tower Defences: 
		- <a href="http://ninjakiwi.com/Espanol/Games/Tower-Defense/Play/Bloons-Tower-Defense.html">Bloons Tower Defence</a>
		- <a href="http://www.xgenstudios.com/play/xenotactic">Xeno Tactics</a>
		<br />
	...
	<div align="center">
	<a href="http://thiaoouba.com/aura_eye_exercise.htm"><img src="small_files/cross-ex-original.gif" border="0" /></a> <br />
	</div>
</body>
</html>